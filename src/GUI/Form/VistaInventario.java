...
public class VistaInventario extends JPanel {
    ...
    // Textos limpios sin símbolos para evitar errores de fuente en Windows
    ...
    */
    private JPanel crearMenuLateral() {
        ...
        panelMenu.setPreferredSize(new Dimension(260, 0)); // Ampliado a 260
    ...
    */
    private JPanel crearAreaTrabajo() {
        ...
        String[] columnas = {"Nombre", "Código", "Stock", "Precio", "Descripción"};
        ...
        // Ajuste de columnas con minWidth para que no se corten
